...
namespace redwyre.DevTools.Toolbar
{
    public class ToolbarItems
    {
        ...
        public static MainToolbarElement OpenCSProject()
        {
            ...
            return new MainToolbarButton(content, static () => { EditorApplication.ExecuteMenuItem("Assets/Open C# Project"); })
            {
                ...
                {
                    menu.AppendAction("Clean Rebuild Projects and Solutions", static (action) =>
                    {
                        Utilities.CleanProjectsAndSolutions();
                        Utilities.BuildProjectsAndSolution();
                    });
                }
            };
        }
