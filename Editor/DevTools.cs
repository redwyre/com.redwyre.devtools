...
namespace redwyre.devtools.Editor
{
    public partial class DevTools : EditorWindow
    {
        ...
        [MenuItem("Window/DevTools/DevTools")]
        ...
        private void ClearBurstCache_clicked()
        {
            ...
            try
            {
                BurstCacheUtilities.ClearBurstCache();

                labelBurstCacheSize.text = PrettyBytes(0);

                StartCalculateBurstCacheSize();
            }
            catch (Exception ex)
            {
        ...
        private void StartCalculateBurstCacheSize()
        {
        ...
        private void RunScript(string scriptPath)
        {
            ...
            Process.Start("pwsh", sb.ToString());
        }
